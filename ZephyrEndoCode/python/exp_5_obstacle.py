...
def control_loop(q_output, result_folder): 
    ...
    pattern = [
            ...
            [[5, 25, 10, 18, 1, 10, 1, 10],[0, 0, 0, 1]],
            [[5, 25, 10, 18, 1, 10, 1, 10],[0, 0, 1, 1]],

            [[1, 25, 25, 25, 1, 25, 1, 1],[0, 0, 1, 1]],
            [[1, 25, 10, 25, 25, 25, 25, 25],[0, 0, 1, 1]],
            [[25, 1, 25, 25, 1, 25, 1, 25],[0, 0, 1, 1]],

            [[15, 1, 15, 1, 10, 1, 10, 1],[0, 0, 1, 1]],
            [[15, 1, 15, 1, 10, 1, 10, 1],[1, 0, 0, 1]],
            [[10, 5, 10, 1, 10, 10, 10, 10],[0, 0, 0, 1]],
            [[10, 5, 10, 1, 10, 10, 10, 10],[0, 0, 1, 1]],

            [[1, 10, 1, 1, 1, 1, 1, 1],[0, 0, 1, 1]],

            [[20, 5, 25, 1, 25, 1, 25, 1],[0, 0, 1, 1]],
            [[20, 5, 25, 1, 25, 25, 25, 25],[0, 0, 1, 1]],
            [[20, 5, 25, 25, 1, 25, 1, 25],[0, 0, 1, 1]],
            [[20, 25, 25, 25, 1, 25, 1, 25],[0, 0, 1, 1]],
            [[1, 25, 25, 25, 1, 25, 1, 25],[0, 0, 1, 1]],

            [[5, 20, 10, 18, 1, 10, 1, 10],[0, 0, 1, 1]],
            [[5, 20, 10, 18, 1, 10, 1, 10],[1, 0, 0, 1]],
        ]
