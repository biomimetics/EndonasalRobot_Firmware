...
def processLine(textLine,index):
 ...
 #           print(textLine)
  ...
  #          print(index, end=',')
        ...
        print("Gage Pressure (PSI) ", convertGagePressureSmall(convertADC(newState.adc11)))
        # print("adc9 value:", convertADC(newState.adc9))
        # print("adc10 value:", convertADC(newState.adc10))
        # print("adc11 value:", convertADC(newState.adc11))
        # print("adc12 value:", convertADC(newState.adc12))
        # print("adc13 value:", convertADC(newState.adc13))
        # print("adc14 value:", convertADC(newState.adc14))
        # print("adc15 value:", convertADC(newState.adc15))
...
def control_loop(): 
    ...
    while ((i < 300) and (not controlStop.is_set())):
        if not stateQ.empty():
            ...
            pressure_value1 = setPressure(1)
            pressure_value2 = setPressure(10)
 #           makeCmd('PFRQ1', value)
 #           makeCmd('PFRQ2', -value)
